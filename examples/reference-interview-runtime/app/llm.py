...
class LLMClient:
    ...
    def generate(
        ...
        *,
        ...
        selected_adapter = (self.settings.llm_adapter or "openai").strip()
        selected_model = self.settings.openai_model.strip()
        default_api_keys = {"ollama": "ollama"}
        default_base_urls = {"ollama": "http://localhost:11434/v1"}
