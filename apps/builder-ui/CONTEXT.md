...
Interface visual local do builder para inspecionar flows, editar propriedades básicas, salvar `agent.flow.json`, validar especificações e acionar geração de runtimes pelo Builder API.
