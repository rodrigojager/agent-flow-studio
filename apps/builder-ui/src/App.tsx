  ...
  return (
    <div className="assets-body">
      ...
      <section className="asset-section">
        ...
        {selectedSchema ? <SchemaVisualEditor content={schemaContent} onChange={onSchemaChange} /> : null}
        <textarea
