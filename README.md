...
- Evoluir o catálogo local inicial para curadoria/versionamento visual mais completa de templates de agentes, skills compostas, tools compostas, filtros avançados e compartilhamento opcional.
