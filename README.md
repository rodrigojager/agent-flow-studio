...
- Evoluir o catálogo local inicial para curadoria visual mais completa, histórico/diff de revisões, templates de agentes, skills compostas, tools compostas e compartilhamento opcional.
