...
- implementado: exportação de fixture JSON por cenário com input, thresholds, checkpoint, pins ativos/stale e metadata de replay;
...
3. consolidar cenários:
   ...
   - fixtures exportáveis por cenário já implementadas;
   - evoluir importação/execução automatizada de fixtures;
