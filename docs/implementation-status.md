...
- Ergonomia refinada do canvas, incluindo grupos colapsáveis, comandos contextuais mais completos e edição visual profunda/recursiva de JSON Schema para objetos aninhados além das propriedades top-level já cobertas.
