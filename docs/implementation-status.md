...
- O catálogo local ainda precisa evoluir de prompts/schemas/tools/templates/skills iniciais para skills compostas, tools compostas, histórico/diff de revisões, curadoria visual completa e compartilhamento opcional.
