...
1. **Canvas/produtos de trabalho refinados (Média prioridade)**
   - grupos colapsáveis e estado stale por nó/aresta a partir de runs/pins/snapshots;
