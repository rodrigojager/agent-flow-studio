...
- Cenários/fixtures do Studio podem ser executados em lote sequencial com resumo por cenário, sessão, duração e erro.
...
3. **Cenários + pinning avançado (Média prioridade)**
   ...
   - ampliar replay por pins com comparação automática de lote e thresholds por tipo de nó;
