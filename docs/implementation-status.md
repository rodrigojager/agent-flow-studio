...
- O catálogo local já possui a primeira camada de tool composta por bundle de nós/arestas; ainda precisa evoluir para editor visual completo de tools compostas, skills compostas, curadoria visual completa e compartilhamento opcional.
