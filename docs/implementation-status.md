...
- O catálogo local já possui a primeira camada de tools/skills compostas por bundle de nós/arestas, permite salvar subgrafos selecionados como blocos reutilizáveis, mostra resumo visual de blocos/templates e permite curadoria visual estrutural de itens locais com prompts/schemas internos editáveis; ainda precisa evoluir para compartilhamento opcional, import/export dedicado de blocos e editor avançado de schemas internos.
