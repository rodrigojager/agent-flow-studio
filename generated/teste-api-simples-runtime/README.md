...
Runtime gerado a partir de `teste-api-simples`.
...
Este pacote ainda inclui `langgraph.json` e `app/langgraph_app.py` para rastreabilidade do grafo aprovado, mas o artefato preferencial para upload/teste no LangSmith é `generated/teste-api-simples-langgraph-sandbox`.

## Nós

- `llm_prompt_1` (llm_prompt)
