...
if (!flowPath || !outDir) {
  console.error("Uso: tsx packages/codegen-langgraph/src/cli.ts --flow <agent.flow.json> --out <dir>");
  process.exit(2);
}
...
console.log(JSON.stringify({ status: "ok", generated: outDir, flow: flow.id }, null, 2));
