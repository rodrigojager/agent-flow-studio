...
const RUNBOOK = "docs/multiagent-operations-runbook.md";
const SCRIPT_NAME = "test:multiagent-operations-runbook";
...
async function main(): Promise<void> {
  ...
  console.log(
    JSON.stringify(
      {
        format: "agent-flow-builder.multiagent-operations-runbook.v1",
        status: "ok",
        runbook: RUNBOOK,
